...
import { BarChart, Calendar2Check } from "react-bootstrap-icons";
      ...
      <main className="container-usermanagement col-md-9 col-lg-11">
        <div className="content-usermanagement px-2 py-2">
          <div className="table-usermanagement">
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 mb-4 mt-4 ms-5">
                  ...
                  <div className="card-body">
                    <div className="row">
                      ...
                      <div className="col">
                        ...
                        <div className="h5 mb-0 fw-bold text-white">10</div>
                      </div>
                    </div>
                  </div>
                </div>
